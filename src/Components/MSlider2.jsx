    ...
    <Slider {...settings}>
      <div className="card-wrapper">
        <div className="card">
          ...
          <div className="details">
            <h2>
              Abhinav Tyagi{" "}
              <span className="job-title">Chemical Engineering</span>
            </h2>
          </div>
        </div>
      </div>
      ...
      <div className="card-wrapper">
        <div className="card">
          ...
          <div className="details">
            <h2>
              Rohan Mishra <span className="job-title">Chemical Engineering</span>
            </h2>
          </div>
        </div>
      </div>
      <div className="card-wrapper">
        <div className="card">
          <div className="card-image">
            <img src="../images/Harshit.jpg" alt="" />
          </div>
          <ul className="social-icons">
            <li>
          ...
          <div className="details">
            <h2>
              Harshit Jain <span className="job-title">Chemical Engineering</span>
            </h2>
          </div>
        </div>
      </div>
